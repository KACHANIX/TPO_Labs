...
class Artist extends Component{
    ...
    async artistsAlike(){
        ...
        console.log(artists);
        ReactDOM.render(<ArtistList name='asd' artists={artists}/>, document.getElementById('items-list'));

    }
    async artistsAlbums(){
        let albums =  await getArtistsAlbums(this.state.artistId);
        console.log(albums);
        ReactDOM.render(<AlbumList name='asd' albums={albums}/>, document.getElementById('items-list'));

    }
    async artistsTopSongs(){
        let songs = await getArtistsTopTracks(this.state.artistId);
        console.log(songs);
        ReactDOM.render(<SongList name='asd' songs={songs}/>, document.getElementById('items-list'));
